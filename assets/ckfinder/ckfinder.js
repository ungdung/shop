            ...
            bz: function P(N) {
                ...
                N.on('themeSpace', function S(Q) {
                    if (Q.data.space == 'mainMiddle') {
                        var R = '';
                        if (!i) R = x[0] + x[3];
                        Q.data.html += "<div id='files_view' class='view ib files_thumbnails' aria-live='polite' role='main' tabindex='0' aria-controls='status_view'><h4 class='tool_panel'></h4><div class='files_thumbnails fake no_list' role='list'></div>" + R + '</div>';
                    }
                });
    ...
    (function () {
        o.add('tools', {
            ...
            addTool: function (r, s) {
                ...
                //r = s ? '<div id="' + t + '" class="view tool_panel" tabindex="0" style="display: none;"></div>' : '<div id="' + t + '" class="tool" style="display: none;">' + r + '</div>';
